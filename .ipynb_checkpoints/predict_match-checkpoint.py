...
df_model = pd.read_csv("df_model_light.csv")   # save this in your notebook beforehand

# Load dictionaries you saved (player_win_pct, h2h_wins, etc.)
player_win_pct = joblib.load("player_win_pct.pkl")
h2h_wins = joblib.load("h2h_wins.pkl")
h2h_matches = joblib.load("h2h_matches.pkl")
win_surface = joblib.load("win_surface.pkl")
matches_surface = joblib.load("matches_surface.pkl")
